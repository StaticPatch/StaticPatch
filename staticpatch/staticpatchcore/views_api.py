...
def api_publish_built_site_view(request, site_slug):
    ...
    if sub_site_url:
        try:
            sub_site = staticpatchcore.models.SubSiteModel.objects.get(site=site, url=staticpatchcore.models.SubSiteModel.normalise_url(sub_site_url), deleted_at__isnull=True)
